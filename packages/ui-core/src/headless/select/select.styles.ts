...
export const selectTriggerSurfaceClassName =
  "border border-input bg-transparent text-foreground hover:bg-[var(--surface)] dark:bg-input/30 dark:hover:bg-[var(--surface)]"
...
export const selectTriggerIconClassName =
  "pointer-events-none inline-flex size-6 items-center justify-center rounded-full bg-[var(--surface)] text-[var(--surface-foreground,var(--foreground))]"
